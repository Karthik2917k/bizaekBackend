...
import * as insuranceAgentController from "../controllers/Admin/insuranceAgentController"; // Import your Insurance Agent controller
...
router.get("/insurance-agent/getAllAgents", checkAdminPermission(), insuranceAgentController.getAllInsuranceAgents);
router.get("/insurance-agent/getAgentById", checkAdminPermission(), insuranceAgentController.getInsuranceAgentById);
router.put("/insurance-agent/updateAgent", checkAdminPermission(), insuranceAgentController.updateInsuranceAgent);
router.put("/insurance-agent/deleteAgent", checkAdminPermission(), insuranceAgentController.deleteInsuranceAgent);
